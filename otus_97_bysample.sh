...
export -f repset97
rm -f data/otus_97_bysample/all_rep_set_otus.txt  # remove all_rep_set_otus if it already exists
parallel repset97 ::: data/otus_97_bysample/*_otus.txt

# Merge all rep sets together
rm -f data/otus_97_bysample/all_rep_set.fasta  # remove all_rep_set if it already exists
rm -f data/otus_97_bysample/all_rep_set_rep_set.fasta  # remove all_rep_set_rep_set if it already exists
cat data/otus_97_bysample/*_rep_set.fasta > data/otus_97_bysample/all_rep_set.fasta
